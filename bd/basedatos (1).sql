...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-10-2018 a las 00:36:44
...
(11, 66, 'xxxxx2', NULL),
(5, 11, 'Categoria2', NULL),
(1, 5, 'Conocer y considerar el propÃ³sito, las funciones y el tipo de entidad; conocer su entorno; y vincular la planeaciÃ³n estratÃ©gica en los diseÃ±os de planeaciÃ³n del Ã¡rea.', NULL),
(67, -1, 'NOMBRE', NULL),
(8, 67, 'xxxxx2', NULL),
(1, 8, 'Categoria2', NULL),
(2, 1, 'Conocer y considerar los lineamientos institucionales macro relacionados con la entidad, emitidos por FunciÃ³n PÃºblica, CNSC, ESAP o Presidencia de la RepÃºblica.', NULL),
(68, -1, 'TALENTO HUMANO233', NULL),
(10, 68, 'xxxxx2', NULL),
(3, 10, 'Categoria2', NULL),
(4, 10, 'catye2', NULL),
(69, -1, 'hola2', NULL),
(7, 69, 'xxxxx2', NULL),
(9, 69, 'NUEVO COMPONENTE', NULL),
(2, 9, 'catye2', NULL),
(70, -1, 'fasdfdf2', NULL);
...
(7, 1, 66, '2018-11-11', '0000-00-00', 0);
...
--
-- Volcado de datos para la tabla `obs_epcc_acge`
--

INSERT INTO `obs_epcc_acge` (`CCA_CODI`, `CCA_EPCC_CODI`, `CCA_ACGE_CODI`, `CCA_PUNT`, `CCA_VALO_CONS`, `CCA_EVID`) VALUES
(1, 5, 1, 0, NULL, NULL),
(2, 1, 2, 0, NULL, NULL);
...
(66, 'AUTODIAGNOSTICO DE GESTION ESTRATEGICA DE TALENTO HUMANO', 'fdfdfdsfds'),
...
--
-- Volcado de datos para la tabla `obs_valo`
--

INSERT INTO `obs_valo` (`VAL_CONS`, `VAL_ACGE_CODI`, `VAL_INFE`, `VAL_SUPE`, `VAL_DESC`) VALUES
(1, 1, 10, 20, '3f3f033f03'),
(2, 3, 12, 13, '18031803fff03'),
(3, 3, 12, 13, '50035003fff03'),
(4, 3, 12, 13, 'wdffdfd'),
(5, 1, 12, 45, 'fdfdfdfdfd'),
(6, 1, 30, 50, 'ValoraciÃ³n'),
(7, 2, 30, 50, 'ValoraciÃ³n');
...
--
ALTER TABLE `obs_enpc`
  MODIFY `EPC_CODI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `obs_epcc`
  MODIFY `ECC_CODI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT de la tabla `obs_epcc_acge`
--
ALTER TABLE `obs_epcc_acge`
  MODIFY `CCA_CODI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `obs_valo`
  MODIFY `VAL_CONS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
